# 100Daly2MQTT [![GitHub release](https://img.shields.io/github/release/softwarecrash/100Daly2MQTT?include_prereleases=&sort=semver&color=blue)](https://github.com/softwarecrash/100Daly2MQTT/releases/latest)
...
- [blink codes](https://github.com/softwarecrash/100Daly2MQTT/wiki/Blink-Codes) for the current state of the ESP (not supported on ESP-01s)
- [Homeassistant Discovery](https://github.com/softwarecrash/100Daly2MQTT/wiki/HomeAssistant-integration)
- [External Temperatur Sensors](https://github.com/softwarecrash/100Daly2MQTT/wiki/Wiring-temperature-sensors)
- with Teapod


**Main screen:**

![image](https://github.com/softwarecrash/100Daly2MQTT/assets/17761850/630b63fa-9093-43e7-a2c0-d4f8648c7ebe)


**Settings:**

![image](https://github.com/softwarecrash/100Daly2MQTT/assets/17761850/f4839109-6d31-4f6b-bfdb-c29350f29c0a)


**Config:**

![image](https://github.com/softwarecrash/100Daly2MQTT/assets/17761850/4b4e9e07-cb65-441c-9ec6-e8e2df84f7c1)
...
# How to use:
- flash your ESP8266 (recommended Wemos D1 Mini) with our [Flash2MQTT-Tool](https://flash.2mqtt.de/?get=100Daly2MQTT) or our desktop [2MQTT-Flasher](https://github.com/all-solutions/2MQTT-Flasher)
...
[![Daly2MQTT-PCB](https://github.com/softwarecrash/100Daly2MQTT/assets/17761850/22e8c226-9603-464c-b1d4-0f7c043b77b4)](https://all-solutions.store)
